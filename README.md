...
Este formato lo puedes conseguir montando tu laberinto en nuestro generador de laberintos [Maze Wall Placer](https://oprobots.github.io/utils/maze-wall-placer.html).
