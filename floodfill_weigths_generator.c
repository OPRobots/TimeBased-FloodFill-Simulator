...
void floodfill_generate_weights() {
  ...
  struct cell_weigth straight_weights[15];
  weight_floodfill_table(180.0f, 1000, 3435, 10000, get_cells_to_max_speed(180.0f, 1000, 3435, 10000), straight_weights);

  printf("\nDIAGONAL\n");
  struct cell_weigth diagonal_weights[15];
  weight_floodfill_table(127.3f, 1000, 3435, 10000, get_cells_to_max_speed(127.3f, 1000, 3435, 10000), diagonal_weights);
}